!function (n) {
  ...
  function r(n, e) {
    ...
    var i = x[x.length - 1];
    if ("top" === n.insertAt) i ? i.nextSibling ? t.insertBefore(e, i.nextSibling) : t.appendChild(e) : t.insertBefore(e, t.firstChild), x.push(e);else if ("bottom" === n.insertAt) t.appendChild(e);else {
  ...
  function f(n, e) {
    var t = e.css,
      i = e.media;
    if (i && n.setAttribute("media", i), n.styleSheet) n.styleSheet.cssText = t;else {
  ...
  var i = function (n) {
    ...
    function f(n) {
      if (n) {
        ...
        if (!isNaN(n.length)) {
          var t = -1,
            i = function e() {
              for (; ++t < n.length;) if (w.call(n, t)) return e.value = n[t], e.done = !1, e;
    ...
    return o.prototype = j.constructor = r, r.constructor = o, r[x] = o.displayName = "GeneratorFunction", n.isGeneratorFunction = function (n) {
      ...
      constructor: h,
      reset: function (n) {
        if (this.prev = 0, this.next = 0, this.sent = this._sent = p, this.done = !1, this.delegate = null, this.method = "next", this.arg = p, this.tryEntries.forEach(u), !n) for (var e in this) "t" === e.charAt(0) && w.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = p);
      },
      stop: function () {
        this.done = !0;
